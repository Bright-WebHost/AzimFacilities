                            ...
                            <div className="row number-block-one-outer justify-content-center">
                                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/73.webp')} alt="" />
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/74.webp')} alt="" />
                                        <div className="figcaption bg-white text-center p-a20">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/75.webp')} alt="" />
                                        <div className="figcaption bg-white text-center p-a20">
