                            ...
                            <div className="row number-block-one-outer justify-content-center">
                                <div className="col-lg-3 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/60.webp')} alt="Diverse facilities management portfolio Qatar — Azim Group Doha" />
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/61.webp')} alt="Innovative facilities management solutions Doha Qatar — Azim FM" />
                                        <div className="figcaption bg-white text-center p-a20" style={{ boxShadow: 'rgba(0,0,0,0.35) 0px 5px 15px' }}>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/62.webp')} alt="ISO certified quality facilities management company Qatar" />
                                        <div className="figcaption bg-white text-center p-a20" style={{ boxShadow: 'rgba(0,0,0,0.35) 0px 5px 15px' }}>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 m-b30">
                                    <div className="number-block-one animate-in-to-top">
                                        <img loading="lazy" height={800} width={1200} src={require('./../../images/azim/63.webp')} alt="Proven facilities management results Qatar businesses Doha" />
                                        <div className="figcaption bg-white text-center p-a20" style={{ boxShadow: 'rgba(0,0,0,0.35) 0px 5px 15px' }}>
